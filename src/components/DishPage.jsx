...
const dishData = {
  brushetta: {
    name: 'Bruschetta',
    ingredients: 'Tomatoes, Basil, Olive Oil, Garlic, Baguette',
    description: 'A classic Italian appetizer made with toasted bread topped with a mix of tomatoes, basil, and garlic.',
    image: brushetta,
  },
  'stuffed-mushrooms': {
